...
import nni
from utils.tools import tsne_visualization
...
class Predictor:
    ...
    def train(self):
        ...
        # if self.conf.training['debug']:
        #     features, adj = self.feats, self.adj
        #     h = self.model(features, adj)
        #     title = (self.data_name + " + " + self.method_name + " + "
        #              + str(self.noise_rate * 100) + " % " + self.noise_type + " noise")
        #     title = title.upper()
        #     tsne_visualization(h, self.clean_label, title)
